...
try:
    from sporsmal_ekteskapsloven_v2 import SPORSMAL as _SP_EKT_V2
except ImportError:
    _SP_EKT_V2 = []

try:
    from sporsmal_husleieloven_v1 import SPORSMAL as _SP_HUS_V1
except ImportError:
    _SP_HUS_V1 = []

try:
    from sporsmal_avhendingslova_v3 import SPORSMAL as _SP_AVH_V3
except ImportError:
    _SP_AVH_V3 = []
...
try:
    from sporsmal_straffeloven import SPORSMAL as _SP_STRAFF
except ImportError:
    _SP_STRAFF = []

try:
    from sporsmal_inkassoloven import SPORSMAL as _SP_INKASSO
except ImportError:
    _SP_INKASSO = []

try:
    from sporsmal_vegtrafikkloven import SPORSMAL as _SP_VEGTRAFIKK
except ImportError:
    _SP_VEGTRAFIKK = []
